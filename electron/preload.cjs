...
contextBridge.exposeInMainWorld('codex', {
  ...
  appServer: {
    ...
    deleteThread: threadId => ipcRenderer.invoke('app-server:thread-delete', threadId),
    setThreadName: payload => ipcRenderer.invoke('app-server:thread-name-set', payload),
    compactThread: threadId => ipcRenderer.invoke('app-server:thread-compact', threadId),
    startReview: payload => ipcRenderer.invoke('app-server:review-start', payload),
    startTerminal: payload => ipcRenderer.invoke('app-server:terminal-start', payload),
    writeTerminal: payload => ipcRenderer.invoke('app-server:terminal-write', payload),
    resizeTerminal: payload => ipcRenderer.invoke('app-server:terminal-resize', payload),
    terminateTerminal: processId => ipcRenderer.invoke('app-server:terminal-terminate', processId),
